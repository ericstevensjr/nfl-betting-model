...
def test_calculate_scoring_margin_for_home_win() -> None:
    assert calculate_scoring_margin(27, 23) == 4


def test_calculate_scoring_margin_for_home_loss() -> None:
    assert calculate_scoring_margin(24, 27) == -3


def test_calculate_ats_margin_for_home_favorite_cover() -> None:
    assert calculate_ats_margin(27, 23, 3.5) == 0.5


def test_calculate_ats_margin_for_home_underdog_cover() -> None:
    assert calculate_ats_margin(24, 27, -6.5) == 3.5


def test_calculate_ats_margin_for_home_favorite_non_cover() -> None:
